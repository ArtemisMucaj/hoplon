...
bash scripts/download_codesearch_binary.sh   # pinned release (v2.0.1) + SHA-256 verify
...
codesearch is pinned to v2.0.1 (the post-extraction build — memory moved to
